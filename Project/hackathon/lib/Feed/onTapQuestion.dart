...
class OnTap2 extends StatefulWidget {
  ...
  OnTap2({Key key, this.userEmail,this.k}) : super(key: key);
  @override
  OnTap2State createState() => OnTap2State(); 
}
class OnTap2State extends State<OnTap2>{
  ...
  Widget build(BuildContext context){
    return Scaffold(
      appBar: AppBar(
        ...
        title: Text('Answers of Question'),
      ),
     body: Column(
        children: <Widget>[
          Flexible(
          ...
          Text("Answer"),
          Divider(),
          Text("Answers by others",style: TextStyle(fontSize: 20),),
          Flexible(
